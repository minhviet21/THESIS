import pandas as pd
import ast
from sklearn.model_selection import valid_test_split
...
valid_data, test_data = valid_test_split(raw_data, test_size=0.5, random_state=42)

valid_data.to_csv("data/clean/valid_data.csv", index=False)
